...
<head>
    ...
    <title>Techos | Ferreterías Bolívar</title>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/MaterialdeConstruccion/Techos/zinc.png" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  ...
                  <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">Techos de Zinc</span>
                      </div>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/MaterialdeConstruccion/Techos/translucido.png" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                  <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">Techos Translucidos</span>
                      </div>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/MaterialdeConstruccion/Techos/policarbonato.png" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">Techos de Policarbonato</span>
                      </div>
                  </div>
