...
<head>
    ...
    <title>Cemento| Ferreterías Bolívar</title>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/MaterialdeConstruccion/Cemento/Chimborazo.png" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  ...
                  <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">Cemento Chimborazo</span>
                      </div>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/MaterialdeConstruccion/Cemento/rocafuerte.png" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                  <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">Cemento Rocafuerte</span>
                      </div>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/MaterialdeConstruccion/Cemento/selvalegre.png" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">Cemento Selvalegre</span>
                      </div>
                  </div>
